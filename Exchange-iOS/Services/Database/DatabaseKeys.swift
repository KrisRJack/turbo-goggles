...
public struct DatabaseKeys {
    ...
    enum Channel: String, DatabaseKeyType {
        ...
        case message_fromFirstName = "message_fromFirstName"
        case message_fromLastName = "message_fromLastName"
        case message_fromDisplayName = "message_fromDisplayName"
        case message_fromUsername = "message_fromUsername"
    ...
    enum Message: String, DatabaseKeyType {
        ...
        case fromFirstName = "fromFirstName"
        case fromLastName = "fromLastName"
        case fromDisplayName = "fromDisplayName"
